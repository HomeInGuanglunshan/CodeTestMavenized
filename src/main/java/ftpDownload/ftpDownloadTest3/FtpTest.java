package ftpDownload.ftpDownloadTest3;
...
//        testUpload();
    ...
    public static void testDownload() {
        ...
        try {
            ftpClient.connect("192.168.11.50",2121);
            ftpClient.login("admin", "admin");

            String remoteFileName = "/home/ampmon/deploy.sh";
            fos = new FileOutputStream("F:/deploy.sh");
